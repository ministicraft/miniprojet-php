...
--
-- Client: localhost
-- Généré le: Sam 26 Novembre 2016 à 18:07
...
CREATE TABLE IF NOT EXISTS `promo` (
  ...
  `localisation` varchar(60) NOT NULL DEFAULT '',
  `annee` varchar(60) NOT NULL,
  `alias` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`type`,`localisation`,`annee`),
  UNIQUE KEY `alias` (`alias`),
  KEY `localisation` (`localisation`),
  KEY `localisation_2` (`localisation`)
...
INSERT INTO `promo` (`type`, `localisation`, `annee`, `alias`) VALUES
('CIR', '', 'A3', NULL),
('CIR', 'BREST', 'A1', NULL),
('CIR', 'BREST', 'A2', NULL),
('CIR', 'RENNES', 'A1', NULL),
